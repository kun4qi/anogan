...
class Discriminator(nn.Module):
    ...
    def __init__(self,
        ...
        self.module_list = nn.Sequential(*sequence)

        self.critic_network = nn.Conv2d(n_filters * nf_mult, out_channels, kernel_size=kw, stride=1, padding=padw)  # output 1 channel prediction map
